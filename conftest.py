...
# This makes the pytest report header mention the tested MLDatabase version
def pytest_report_header(config):
    from mldatabase.__version__ import __version__
    return("MLDatabase: %s" % (__version__))
